...
object Registry:
  val all: List[Activity] = List(Battleships, Solitaire, TicTacToe, Memory, MemoryChain, Hangman, Checkers, Chess, Sudoku, Minesweeper, WordAssociation, Categories, TwentyQuestions, ISpy, StoryBuilding, LastLetter, WouldYouRather, WordBuilder, MathPractice, Clock, Reading)
