...
/** The shared drawing surface: a pointer-driven canvas with a crayon palette,
  * three brush sizes, and a clear button. The Paint tool is this and nothing
  * more; Draw & Guess mounts one per round.
  */
object PaintSurface:
